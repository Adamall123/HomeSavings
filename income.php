	...
	<div class="topnav" id="myTopnav" >
	 ...
	 <?php 
			if(isset($_SESSION['addedIncome'])){
				...
				<i class="fas fa-search-dollar" style="color: green";></i>
				 <?php  echo $_SESSION['addedIncome'];
        ...
        <div class="lowerPanel" style="height: 355px;">
            ...
            <form method="POST" action="addIncome.php" >
                <div class="inputPanel">
                    <input type="number" name="amount" step="0.01" placeholder="0.00" min="0.01" max="99999999.99" class="form-control" value="0">
                </div>
